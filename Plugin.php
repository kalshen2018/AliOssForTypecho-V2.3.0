 ...
 * @author droomo.
 * @version 2.3.0-for-typecho-v1.3
...
class AliOssForTypecho_Plugin extends Typecho_Widget implements Typecho_Plugin_Interface {
    ...
    public static function activate() {
        ...
        Typecho_Plugin::factory('Widget_Upload')->attachmentHandle     = Config('AliOssForTypecho_Plugin', 'attachmentHandle');
...
<h3>插件使用说明</h3>
<ol>
<li>(最新修复typecho_v1.3钩子数据类型改动问题)，我已将插件用于<a href="https://51gameart.com">51gameart.com</a> 网站中</li>
<li>插件升级基于<a href="https://github.com/aliyun/aliyun-oss-php-sdk/releases/tag/v2.7.2">aliyun-oss-php-sdk Release 2.7.2</a>开发（解决适配PHP8+上传失败问题），
若以后SDK开发包更新导致插件不可用，请到 <a target="_blank" href="https://www.droomo.top/AliOssForTypecho.html">原开发者的博客^-^</a>。<br/></li>
...
<li>如有问题或建议请到 <a target="_blank" href="https://www.droomo.top/AliOssForTypecho.html">原作者的博客https://www.droomo.top/AliOssForTypecho.html</a> 留言</li>
</ol>
...
<?php
    ...
    public static function uploadHandle($file) {
        ...
        $remote_file_name = $user_dir . $relative_path . $file_name;
        ...
        if ($save_on_server === "1" && !Typecho_Common::isAppEngine()) {
            ...
            $local_file_name = $upload_root . $relative_path . $file_name;
            try{
            ...
            if ($exist_on_oss || $exist_on_server) {
                ...
                for ($i = 1;; $i++) {
                    $file_name = $pathinfo['filename'] . '(' . strval($i) . ').' . self::getExtentionName($file_name);
                    $remote_file_name = $user_dir . $relative_path . $file_name;
                    $local_file_name = $upload_root . $relative_path . $file_name;
     ...
     * @return string
     */
    public static function attachmentHandle(Config $attachment) {
        $options    = Typecho_Widget::widget('Widget_Options');
        ...
        if (empty($cdnUrl)) {
            ...
            return 'https://' . $bucket_name . '.' . $end_point . '.aliyuncs.com/' . $userDir . $attachment->path . $diy_style;
        } else {
            return $cdnUrl . $userDir . $attachment->path . $diy_style;
        }
    }
